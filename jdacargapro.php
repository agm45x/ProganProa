...
<head>
  ...
  <title>INFORME FINANCIERO CARGAPRO</title>
...
<body class="bi-page">
  ...
  <section class="bi-container">
    <h1 class="bi-title">INFORME FINANCIERO CARGAPRO</h1>

    <!-- Aquí colocas el iframe del Power BI -->
    <div class="bi-frame-wrapper">
      <iframe 
        title="INFORME FINANCIERO CARGAPRO"
        width="100%"
        height="775"
        src="https://app.powerbi.com/view?r=eyJrIjoiNGI4YTM0OTAtYzA1My00YzBmLWE4YzgtMjI4M2YzMWU0NzM5IiwidCI6IjM3YzA2NzQ2LTdjNmItNDNhYy1iNGNkLWRmZmU5NmFmNjZkZCIsImMiOjR9"
        frameborder="0"
