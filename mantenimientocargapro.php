...
<head>
  ...
  <title>INFORME DE MANTENIMIENTO CARGAPRO</title>
...
<body class="bi-page">
  ...
  <section class="bi-container">
    <h1 class="bi-title">INFORME DE MANTENIMIENTO CARGAPRO</h1>

    <!-- Aquí colocas el iframe del Power BI -->

    <div class="bi-frame-wrapper">
      <iframe 
        title="INFORME DE MANTENIMIENTO CARGAPRO"
        width="100%"
        height="775"
        src="https://app.powerbi.com/view?r=eyJrIjoiMWYxZmU0M2YtMjZkMy00MDM3LWJiMzItOTBhY2Q3NzAwNzY0IiwidCI6IjM3YzA2NzQ2LTdjNmItNDNhYy1iNGNkLWRmZmU5NmFmNjZkZCIsImMiOjR9"
        frameborder="0"
