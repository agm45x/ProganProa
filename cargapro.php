...
<header class="topbar">
  <div class="logo-texto">
    ...
    <img src="imagenes/Logo CargaPRO.png" alt="Logo Cargapro" class="logo">
  </div>
</header>
...
<section class="portada">
  ...
  <!-- ===== CONTENEDOR GENERAL DE BOTONES ===== -->
    ...
    <a href="jdacargapro.php" class="img-circle">
    <img src="imagenes/Boton Visor.png" alt="jdacargapro">
    </a>
    <a href="operativocargapro.php" class="img-circle">
    <img src="imagenes/Boton Operaciones.png" alt="operativocargapro">
    </a>
    <a href="mantenimientocargapro.php" class="img-circle">
