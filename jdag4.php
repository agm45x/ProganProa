...
<head>
  ...
  <title>INFORME FINANCIERO G4 SERVICES</title>
...
<body class="bi-page">
  ...
  <section class="bi-container">
    <h1 class="bi-title">INFORME FINANCIERO G4 SERVICES</h1>

    <!-- Aquí colocas el iframe del Power BI -->

    <div class="bi-frame-wrapper">
      <iframe 
        title="INFORME FINANCIERO G4 SERVICES"
        width="100%"
        height="775"
        src="https://app.powerbi.com/view?r=eyJrIjoiNjYwMmFjYWEtNTA4ZC00YzQyLTg4YmYtNGM4OGEwNjJkOGM3IiwidCI6IjM3YzA2NzQ2LTdjNmItNDNhYy1iNGNkLWRmZmU5NmFmNjZkZCIsImMiOjR9"
        frameborder="0"
